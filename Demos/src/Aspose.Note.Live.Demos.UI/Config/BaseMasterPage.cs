...
namespace Aspose.Note.Live.Demos.UI.Config
{
    ...
    {
        private AsposeNoteContext _atContext;

        /// <summary>
        /// Main context object to access all the SybContent specific context info
        /// </summary>
        public AsposeNoteContext AsposeNoteContext
		{
            get
            {
                if (_atContext == null) _atContext = new AsposeNoteContext(HttpContext.Current);
                return _atContext;
            }
        }
		...
		public Dictionary<string, string> Resources
		{
			get
			{
				if (_resources == null) _resources = AsposeNoteContext.Resources;
				return _resources;
			}
		}
		...
		protected override void OnLoad(EventArgs e)
        {
			...
			AsposeNoteContext.atcc = AsposeNoteContext;
            base.OnLoad(e);
        }
    }
}
