...
namespace Aspose.Note.Live.Demos.UI.ViewerApp
{
	public partial class Default : BasePage
	{
        ...
        protected void Page_Load(object sender, EventArgs e)
		{
			if (!IsPostBack)
			{
                ...
                apiUrl = Configuration.AsposeNoteLiveDemosPath;

                Page.Title = Resources["noteViewerPageTitle"];
				Page.MetaDescription = Resources["noteViewerMetaDescription"];
			}
		}
