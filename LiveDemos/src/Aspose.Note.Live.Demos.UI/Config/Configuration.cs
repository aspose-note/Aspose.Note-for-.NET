...
namespace Aspose.Note.Live.Demos.UI.Config
{
	...
	{		
		...
		private static string _asposeNoteLiveDemosPath = ConfigurationManager.AppSettings["AsposeNoteLiveDemosPath"].ToString();
        ...
        public static string AsposeNoteLiveDemosPath
        {
            get { return _asposeNoteLiveDemosPath; }
        }
